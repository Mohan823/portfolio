    ...
    function generateCard() {
        return (
            <li className="hover:transition-all duration-700 border border-gray-200/10 hover:border-gray-200/50 hover:shadow-none hover:translate-x-1 hover:translate-y-1 shadow-lg p-7 rounded-lg">
                ...
                <span className="text-white indent-2">&nbsp;&nbsp;&nbsp;&nbsp;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima tempora dolorum dolor illum perferendis eos? Aspernatur dolores, placeat non tempore a accusamus libero. Sunt officia consequuntur amet debitis eum veritatis! </span>
            </li>
        )
    }
